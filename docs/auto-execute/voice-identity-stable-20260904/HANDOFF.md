...
- Owner packs: `work/acceptance/stable-voice-five-turn-20260904/owner-production-safe-only` and `owner-blind` (BOUNDED_ALL stress pack).
...
- Open gate: familiar-listener scores and `DRIFT_AT_T2` decision.
