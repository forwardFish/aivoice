...
const envVariables = {
  ...
  AIVOICE_STABLE_EMOTION_MODE: process.env.AIVOICE_STABLE_EMOTION_MODE || localEnv.AIVOICE_STABLE_EMOTION_MODE || 'OFF',
  AIVOICE_CHAT_STYLE_MODE: process.env.AIVOICE_CHAT_STYLE_MODE || localEnv.AIVOICE_CHAT_STYLE_MODE || 'EVERYDAY',
  AIVOICE_CHAT_PHRASING_MODE: process.env.AIVOICE_CHAT_PHRASING_MODE || localEnv.AIVOICE_CHAT_PHRASING_MODE || 'OFF',
