...
const envVariables = {
  ...
  AIVOICE_VOICE_STRATEGY: localEnv.AIVOICE_VOICE_STRATEGY || 'single',
  AIVOICE_DUAL_VOICE_ENABLED: localEnv.AIVOICE_DUAL_VOICE_ENABLED || '',
  AIVOICE_SEED_AUDIO_BUDGET_WINDOW: localEnv.AIVOICE_SEED_AUDIO_BUDGET_WINDOW || '50',
  AIVOICE_SEED_AUDIO_BUDGET_LIMIT: localEnv.AIVOICE_SEED_AUDIO_BUDGET_LIMIT || '15',
