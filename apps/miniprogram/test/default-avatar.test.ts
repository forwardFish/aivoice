...
test('only explicit relationship labels receive a matching default portrait', () => {
...
test('ambiguous names keep the neutral fallback instead of guessing identity or gender', () => {
  assert.equal(resolveVoiceAvatar({ id: 'rain', name: '小雨 · 5岁' }), '')
