...
test('home page consumes provided visual assets and custom tabbar shell', () => {
  ...
  const homeStyles = fs.readFileSync(path.join(appRoot, 'pages/home/index.wxss'), 'utf8')
  ...
  assert.doesNotMatch(homeMarkup, /hero-menu|more-circle\.png/)
  assert.doesNotMatch(homeStyles, /\.hero-menu\s*\{/)
